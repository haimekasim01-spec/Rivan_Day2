...
Windows Server 2022:
  ...
  | Network Adapter 6 | Bridged (Replicate) | 10.61.1.8 /24 |
...
## Web Server
__Configure Web Server (net61.com)__  
1. Internet Information Services Manager
2. Create an `http` mapping for the domain `www.net61.com`
...
__Create Accounts For `net61.com`__
1. Support
2. Admin
3. User
...
conf t
 ...
 radius server WINRAD
  address ipv4 10.61.1.8 auth-port 1812 acct-port 1813
  key keykeymo
  exit
...
- A Record : utmph.net61.com : 208.8.8.11
